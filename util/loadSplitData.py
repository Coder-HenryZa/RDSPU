...
# cwd1=os.getcwd()
# cwd1,_=os.path.split(os.getcwd())

def loadSplitData(obj, fold = 3):

    labelPath = './datasets/' + obj + '/' + obj + '_label_All.txt'
    ...
    data_split = [[fold0_test,fold0_train],[fold1_test,fold1_train],[fold2_test, fold2_train],[fold3_test,fold3_train],[fold4_test,fold4_train]]
